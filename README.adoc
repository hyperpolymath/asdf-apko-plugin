...
:url-repo: https://github.com/hyperpolymath/asdf-apko-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-apko-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-apko-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-apko-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Apko] versions.
...
Apko is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Apko versions per project

|**Project Isolation**
|Pin Apko per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Apko version
...
=== Installing Apko Versions

[source,bash]
----
asdf list all apko
asdf install apko latest
asdf install apko 0.1.0
----
...
[source,bash]
----
asdf global apko 0.1.0
asdf local apko 0.1.0
asdf current apko
apko --version
----
...
* Ensure `apko` is on PATH after installation.
* Verify the installed version with `apko --version`.
